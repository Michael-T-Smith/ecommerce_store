...
export const MOCK_USERS = [
  { id: 1, name: "Candice Morgan", role: ROLES.ADMIN,    email: "candice@company.com" },
  { id: 2, name: "Jane Holloway",  role: ROLES.MANAGER,  email: "jane@company.com"    },
  { id: 3, name: "Tom Reeves",     role: ROLES.EMPLOYEE, email: "tom@company.com"     },
];
