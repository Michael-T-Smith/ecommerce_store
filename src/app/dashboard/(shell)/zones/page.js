...
// Admin can add, rename, reprice, reorder, and toggle zones.
      ...
      {modalMode && (
        ...
        >
          <div className="bg-white w-full max-w-[440px] border-[3px] border-brand-black shadow-retro-lg overflow-hidden">
            <div className="px-6 py-4 border-b-[3px] border-brand-black flex items-center justify-between" style={{ background: C.blush }}>
