...
const DELIVERY_STATUSES = [
  ...
  { key: "dispatched", label: "Dispatched", color: "#C08FA3" },
...
const ZONE_META = {
  piedmont: { label: "Piedmont", color: "#C08FA3" },
  anniston: { label: "Anniston", color: "#BFA05C" },
  centre  : { label: "Centre",   color: "#1D1B1C" },
};
          ...
          <div key={col.key} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              {col.items.map((delivery) => {
                const zoneMeta   = ZONE_META[delivery.zone] ?? { label: delivery.zone, color: "#8C8288" };
                const nextStatus = STATUS_NEXT[delivery.status];
