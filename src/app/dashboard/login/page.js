      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          >
            ...
            />
            <div className="z-10">
              <FlowerMark size={40} fill={B.cream} stroke={B.black} />
            </div>
            {/* Gold pinstripe ring */}
        ...
        <div className="bg-white border-[3px] border-brand-black shadow-retro-lg overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            <p className="font-sans text-brand-smoke text-[13px] mb-7">
              Use your Lamb&apos;s Florist staff credentials.
            </p>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="you@lambsflorist.com"
                autoComplete="email"
                disabled={loading}
        ...
        <p className="text-center font-sans text-[11px] text-brand-cream/30 mt-6 tracking-[1px]">
          Lamb&apos;s Florist Internal Dashboard · Not for public access
        </p>
      </div>
    </div>
  );
