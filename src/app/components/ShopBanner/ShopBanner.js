    ...
    <section className="bg-brand-black relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `repeating-linear-gradient(-55deg,
            ...
            rgba(212,81,26,0.08) 48px, rgba(212,81,26,0.08) 56px,
            transparent 56px, transparent 62px,
            rgba(212,81,26,0.04) 62px, rgba(212,81,26,0.04) 66px)`,
        }}
      />
      ...
      <div className="relative z-10 px-5 sm:px-10 lg:px-16 py-12 sm:py-16 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
        ...
        <div>
          ...
          <h1 className="font-serif font-black text-brand-cream text-[40px] sm:text-[52px] lg:text-[64px] tracking-[-2px] leading-none m-0">
            {title}
          </h1>
          {subtitle && (
        ...
        <div className="hidden sm:flex items-center justify-center w-[100px] h-[100px] lg:w-[120px] lg:h-[120px] bg-brand-orange rounded-full border-[4px] border-brand-cream relative flex-shrink-0">
          ...
          />
          <div className="z-10">
            <FlowerMark size={52} fill={B.cream} stroke={B.black} />
          </div>
