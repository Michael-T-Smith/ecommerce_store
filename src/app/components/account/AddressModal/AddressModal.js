      ...
      <div className="bg-white border-[3px] border-brand-black w-full max-w-[480px] shadow-retro-lg overflow-hidden">
        ...
        <div className="h-[5px]" style={{
          background: `repeating-linear-gradient(90deg,
            ${B.orange} 0, ${B.orange} 30px,
            ${B.gold}   30px, ${B.gold}   38px,
            ${B.orange} 38px, ${B.orange} 68px,
            ${B.black}  68px, ${B.black}  72px)`,
        }} />
        ...
        <div className="px-6 py-6 flex flex-col gap-4">
            ...
            <div className="flex gap-2 mb-2">
              {["Home", "Work", "Other"].map((preset) => (
                <button key={preset}
                  ...
                  style={{
                    borderColor: form.label === preset ? B.orange : "#E5E7EB",
                    color      : form.label === preset ? B.orange : B.smoke,
                    background : form.label === preset ? `${B.orange}10` : "white",
                  }}>
                  {preset}
                </button>
              ))}
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            <div
              ...
              style={{
                borderColor: form.isDefault ? B.orange : "#D1D5DB",
                background : form.isDefault ? B.orange : "white",
              }}
