  ...
  if (inCart && !multiSize) {
    return (
      <div className="flex items-center gap-0 border-[2px] border-brand-black overflow-hidden">
        ...
        <div className={`${qty} bg-brand-orange text-brand-black font-sans font-black flex items-center justify-center px-1 leading-none`}>
          {totalInCart}
        </div>
        <button
        ...
        <button
          ...
          className={`${sz} flex items-center justify-center border-none cursor-pointer font-black transition-colors leading-none ${
            isPickerOpen
              ...
              : "bg-brand-black text-brand-cream hover:bg-brand-orange hover:text-brand-black"
          }`}
  ...
  if (!multiSize) {
    return (
      <button
        ...
        className={`${btnBase} ${px} bg-brand-black text-brand-cream hover:bg-brand-orange hover:text-brand-black`}
      >
        + Bag
      </button>
    );
