...
const FAQS = [
  ...
  },
  {
    ...
    a: "Our drivers will leave the arrangement in a safe, shaded spot at the door and send a delivery photo. If there's no safe location, we'll call the recipient and arrange a second attempt at no extra charge. We never leave flowers in direct sunlight.",
  },
  {
  ...
  },
  {
    ...
    a: "Every order includes a handwritten note at no extra cost. You'll enter your message during checkout. We handwrite it on our branded notecard before the arrangement leaves the studio.",
  },
  {
    q: "What if the flowers arrive damaged?",
    a: "That has never happened and we intend to keep it that way — but if it ever does, call us immediately. We will replace the arrangement same-day or next-day at no charge. No photos required, no questions asked.",
  },
  {
    q: "Do you deliver outside Piedmont, Anniston, and Centre?",
    a: "Not currently for standard orders. For weddings, events, or large orders outside our standard zones, contact us directly — we handle those on a case-by-case basis and will always find a way to make it work.",
  },
];
                ...
                >
                  ...
                  >
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                      <line x1="6" y1="1" x2="6" y2="11" stroke={isOpen ? B.cream : B.cream} strokeWidth="2" strokeLinecap="round" />
                      <line x1="1" y1="6" x2="11" y2="6" stroke={isOpen ? B.cream : B.cream} strokeWidth="2" strokeLinecap="round" />
                    </svg>
                  </div>
                </button>
