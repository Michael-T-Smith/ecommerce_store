                  ...
                  <span
                    ...
                    style={
                      item.location === "centre"
                        ? { color: "#1D1B1C", borderColor: "#1D1B1C40", background: "#1D1B1C12" }
                        : { color: C.blush,  borderColor: `${C.blush}40`, background: `${C.blush}10` }
                    }
                  >
                  ...
                  {item.isFeatured ? (
                    <div className="flex flex-col items-center gap-1">
                      ...
                      <div
                        ...
                        style={{ background: item.featuredAccent ?? "#C08FA3" }}
                        title={`Accent: ${item.featuredAccent ?? "#C08FA3"}`}
                      />
                    </div>
                  ) : (
