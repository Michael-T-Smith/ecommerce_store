        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* In Bag badge */}
              {inCart && item.inStock && (
                <div className="absolute top-3 left-0 bg-brand-orange text-brand-cream font-sans font-extrabold text-[9px] tracking-[1.5px] uppercase px-3 py-1 border-r-[3px] border-brand-black z-[3] flex items-center gap-1.5">
