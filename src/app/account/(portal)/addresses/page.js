...
export default function AddressesPage() {
  ...
  if (loading) return <div className="flex justify-center py-24"><svg className="animate-spin" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke={B.orange} strokeWidth="2.5"><path d="M21 12a9 9 0 11-6.219-8.56" /></svg></div>;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {addresses.map((addr) => (
            <div key={addr.id}
              ...
              style={{ borderLeft: addr.isDefault ? `4px solid ${B.orange}` : undefined }}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {addr.isDefault && (
                      <span className="font-sans font-extrabold text-[9px] tracking-[1px] uppercase px-2 py-0.5 border"
                        style={{ color: B.orange, borderColor: `${B.orange}50`, background: `${B.orange}10` }}>
                        Default
                      </span>
                    )}
                  </div>
